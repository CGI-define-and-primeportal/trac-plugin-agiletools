...
(function($, Class, History) { "use strict";
  ...
  var MilestoneTicket = Class.extend({
    ...
    draw: function() {
      ...
      this.$ticketOptions = $("<i class='icon-fullscreen more-options'></i>").appendTo(this.$moreOptions);
  ...
  function milestones_from_query() {
    ...
    /**
     * Removes visible jQuery UI tooltips from the window. This does not 
     * stop further tooltips being created.
     */
